...
#3:7,n_estimators=70,random_state=10
# from sklearn.multiclass import OneVsRestClassifier
# rf0 = OneVsRestClassifier(rf0)
rf0.fit(X_train, y_train)
#print rf0.feature_importances_


print("测试模型有效性:",rf0.score(X_train,y_train))
print("基础验证的准确率:",rf0.score(X_test,y_test))

from sklearn import metrics
print(metrics.classification_report(y_train,rf0.predict(X_train)))
print(metrics.classification_report(y_test,rf0.predict(X_test)))
